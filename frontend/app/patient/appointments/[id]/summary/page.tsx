...
export default function PostVisitSummaryPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        <h1 className="text-lg font-semibold text-gray-900">Post-Visit Summary</h1>
        ...
        <CardBody className="space-y-2">
          ...
          {summary.llmStatus === 'FALLBACK' && (
            <div className="border border-amber-300 bg-amber-50 rounded-md p-3 text-sm text-amber-900 mt-2">
              ...
              <p className="mt-1">This is a standard fallback summary. The AI service was unable to generate a personalized summary. Please contact your provider if you have questions about your visit.</p>
            </div>
          )}
        </CardBody>
      </Card>
